                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link href="#" className="d-inline-block"><img src={img1} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                ...
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link href="#" className="d-inline-block"><img src={img2} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                    <td data-label="Item Name">
                                    <div className="itemInfo">
                                ...
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link href="#" className="d-inline-block"><img src={img3} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                    <td data-label="Item Name">
                                    <div className="itemInfo">
