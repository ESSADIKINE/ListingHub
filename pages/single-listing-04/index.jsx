...
const logo4 = '/assets/img/logo-4.png'
const tick = '/assets/img/tick.svg'
const bg = '/assets/img/single-4.jpg'
                                ...
                                <div className="firstColumn">
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        <div className="listingAvatar">
                                            <Link href="#" className="d-block"><img src={logo4} className="img-fluid rounded-3" width="95" alt="Avatar"/></Link>
                                        </div>
