...
const bg = '/assets/img/avatar-bg-2.jpg'
const user = '/assets/img/team-4.jpg'
                                                ...
                                                <div className="row align-items-center justify-content-start g-3">
                                                    ...
                                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <div className="listThumb overflow-hidden position-relative">
                                                            ...
                                                            <Link href="#" className="d-block"><img src={item.image} className="img-fluid list-thumb object-fit" alt="Listing Img"/></Link>
                                                        </div>
                                                    </div>
                                ...
                                <div className="col-xl-12 col-lg-12 col-md-12">
                                    <nav aria-label="Page navigation example">
                                        <ul className="pagination justify-content-center">
                                            ...
                                            <li className="page-item">
                                                <Link href="#" className="page-link"><i className="fa-solid fa-arrow-right"></i></Link>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
