...
export default function ListLayout4() {
  return (
    <>
        <NavLightTwo/>
                                                ...
                                                <div className="listTitle d-block mb-4">
                                                    <div className="d-flex align-items-start justify-content-between gap-2">
                                                        <div className="flex-first">
                                                            ...
                                                            <h5 className="listItemtitle mb-3"><Link href={`/single-listing-04/${item.id}`}>{item.title}<span className="verified"><BsPatchCheckFill className="m-0"/></span></Link></h5>
                                                        ...
                                                        <div className="flex-last">
                                                            <Link href="#" className="bookmarkList"><FaHeart className=""></FaHeart></Link>
                                                        </div>
                                                    </div>
                                                </div>
