...
import { BsGeoAlt, BsList, BsPatchCheckFill, BsSearch, BsStar, BsStars, BsSuitHeart, BsTelephone, BsUiRadiosGrid } from 'react-icons/bs'
                                ...
                                <div className="viewOptions">
                                    <ul className="nav nav-pills nav-fill gap-2 small d-inline-flex primary-soft rounded-2">
                                        <li className="nav-item" role="presentation">
                                            <Link href="/list-layout-03" className="nav-link rounded-2"><BsList className="me-2"/>List</Link>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <Link href="/grid-layout-03" className="nav-link rounded-2 active"><BsUiRadiosGrid className="me-2"/>Grid</Link>
                                        </li>
                                    </ul>
                                </div>  
                            </div>
                                            ...
                                            <div className="singlelisting-item">
                                                ...
                                                <div className="listing-middle-item">
                                                    ...
                                                    <div className="listing-details">
                                                        <h4 className="listingTitle"><Link href={`/single-listing-03/${item.id}`} className="titleLink">{item.title}<span className="verified"><BsPatchCheckFill className="bi bi-patch-check-fill m-0"/></span></Link></h4>
                                                        <p>{item.desc}</p>
                                                    </div>
