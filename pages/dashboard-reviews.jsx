                                                                            ...
                                                                            <div className="reviewssupper d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                                                                ...
                                                                                <div className="flxLast">
                                                                                    <div className="reviewsStar" data-rating="5">
                                                                                        <BsStarFill className="bi bi-star-fill me-1"/>
                                                                                        <BsStarFill className="bi bi-star-fill me-1"/>
                                                                                        <BsStarFill className="bi bi-star-fill me-1"/>
                                                                                        <BsStarFill className="bi bi-star-fill me-1"/>
                                                                                        <BsStarHalf className="bi bi-star-half"/>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body p-md-5">
                        <div className="messageForm">
                            ...
                            <button type="button" className="btn btn-primary fw-medium px-md-5">Reply<i className="bi bi-arrow-right ms-2"></i></button>
                        </div>
                    </div>
                </div>
            </div>
