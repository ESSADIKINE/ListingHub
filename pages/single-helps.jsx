                    ...
                    <div className="helpNav">
                        <nav id="single-helps" className="h-100 flex-column align-items-stretch pe-4">
                            <nav className="nav nav-pills light flex-column">
                                <Link1 className="nav-link ms-3 my-1" href="item-1" smooth={true} duration={500}>How Do I Add Or Change My Billing Details?</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-2" smooth={true} duration={500}>How do I purchase an item?</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-3" smooth={true} duration={500}>How do refunds work?</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-4" smooth={true} duration={500}>I'm trying to find a specific item</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-5" smooth={true} duration={500}>Envato and the Envato Market sites</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-6" smooth={true} duration={500}>Purchasing Items As A Member</Link1>
                                <Link1 className="nav-link ms-3 my-1" href="item-7" smooth={true} duration={500}>Buyers Guide to YouTube Content ID & ...</Link1>
                            </nav>
                        </nav>
                    </div>
                </div>
