...
const car1 = '/assets/img/car-1.jpg'
const car2 = '/assets/img/car-2.jpg'
const car3 = '/assets/img/car-3.jpg'
const car4 = '/assets/img/car-4.jpg'
                                ...
                                {car.map((item,index)=>{
                                    return(
                                        <SwiperSlide className="gallery-slides" key={index}>
                                            <Link href="#" onClick={() => handleImageClick(index)}className="mfp-gallery"><img src={item} className="img-fluid" alt="brand image"/></Link>
                                        </SwiperSlide>
                                    )
                                })}  
                            </Swiper>
