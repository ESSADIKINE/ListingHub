...
import bg from '../../assets/img/banner-5.jpg'
...
import CategoriesThree from '../../components/categories-three'
...
import FooterToptwo from '../../components/footer-top-two'
...
export default function IndexSeven() {
  return (
    <>
        ...
        <div className="image-cover hero-header full-height position-relative" style={{backgroundImage:`url(${bg})`}} data-overlay="6">
            ...
            <div className="mousedrop z-1"><Link to="#" className="mousewheel center"><BsMouse className=""/></Link></div>
        </div>

        <section className="py-5 pb-0">
            <div className="container">
                <div className="row align-items-center justify-content-between g-xl-4 g-3">
                    {reviewData2.map((item,index)=>{
                        return(
                            <div className="col-xl-4 col-lg-4 col-md-4" key={index}>
                                <div className="ratingcaption text-center">
                                    <div className="figureimg mb-3"><img src={item.image} width="50" className="img-fluid" alt=""/></div>
