...
import bg from '../../assets/img/banner-8.jpg'
...
export default function IndexTen() {
  return (
    <>
        ...
        <div className="image-cover hero-header bg-primary position-relative" style={{backgroundImage:`url(${bg})`}} data-overlay="6">
            ...
            <div className="mousedrop z-1"><Link to="#mains" className="mousewheel center"><BsMouse/></Link></div>
        </div>
