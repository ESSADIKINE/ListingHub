...
import { FaShoppingBag, FaSpa } from 'react-icons/fa'
import { FaBowlRice, FaMartiniGlass, FaMugSaucer } from 'react-icons/fa6'
import CategoriesFour from '../../components/categories-four'
...
export default function IndexEight() {
  return (
    <>
        ...
        <div className="image-cover hero-header" style={{backgroundImage:`url(${bg})`, backgroundColor:'#fff0f2'}}>
                    ...
                    <div className="col-xl-7 col-lg-8 col-md-11 col-sm-12">
                        <div className="d-block position-relative">
                            <div className="popularSearches d-flex align-items-center justify-content-center gap-4 flex-wrap">
                                <div className="singleItem"><Link to="#" data-bs-toggle="tooltip" data-bs-title="Beauty & Spa" className="badge-success square--80 rounded-pill"><FaSpa className="fs-3"/></Link></div>	
                                <div className="singleItem"><Link to="#" data-bs-toggle="tooltip" data-bs-title="Eat & Drink" className="badge-danger square--80 rounded-pill"><FaBowlRice className="fs-3"/></Link></div>	
                                <div className="singleItem"><Link to="#" data-bs-toggle="tooltip" data-bs-title="Shopping" className="badge-info square--80 rounded-pill"><FaShoppingBag className="fs-3"/></Link></div>	
                                <div className="singleItem"><Link to="#" data-bs-toggle="tooltip" data-bs-title="Nightlife" className="badge-warning square--80 rounded-pill"><FaMartiniGlass className="fs-3"/></Link></div>	
                                <div className="singleItem"><Link to="#" data-bs-toggle="tooltip" data-bs-title="Coffee Shop" className="badge-primary square--80 rounded-pill"><FaMugSaucer className="fs-3"/></Link></div>		
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="d-flex align-items-center justify-content-between gap-4 p-3 bg-light-primary border border-primary flex-wrap gap-3 rounded-3">
                            <div className="freeprcIcon">
                                <div className="freeprcBocses d-flex align-items-center justify-content-start gap-3">
                                    <div className="freeprcFirst"><span className="square--60 bg-primary text-light circle"><i className="bi bi-patch-check-fill h-auto fs-4"></i></span></div>
