...
import bg from '../../../assets/img/single-2.jpg'
                                ...
                                <div className="firstColumn">
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        ...
                                        <div className="listingCaptioninfo">
                                            <div className="propertyTitlename d-flex align-items-center gap-2 mb-1"><h2 className="fw-semibold text-light mb-0">{data?.title ? data.title : 'Sangam Apartment'}</h2><span className="verified mt-1"><img src={tick} className="img-fluid" width="22" alt="Verified Listing"/></span></div>
                                            <div className="listingsbasicInfo">
                                                <div className="d-flex align-items-center justify-content-start flex-wrap gap-2">
                                                    ...
                                                    <div className="flexItem me-2"><span className="text-md fw-medium text-light"><BsBriefcase className="me-2"/>{data?.tag ? data.tag : 'Apartment'}</span></div>
