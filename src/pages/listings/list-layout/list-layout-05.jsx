...
export default function ListLayout5() {
  return (
    <>
        <ThemNavbar/>
                            ...
                            <div className="heroSearch style-01 mt-4">
                                <div className="row gx-lg-2 gx-md-2 gx-3 gy-sm-2 gy-2">
                                    ...
                                    <div className="col-xl-2 col-lg-3 col-md-12 col-sm-12">
                                        <div className="form-group">
                                            <button type="button" className="btn btn-primary full-width fw-medium"><BsSearch className="me-2"></BsSearch>Search</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div className="listTitle d-block mb-4">
                                                            <div className="d-flex align-items-start justify-content-between gap-2">
                                                                <div className="flex-first">
                                                                    ...
                                                                    <h5 className="listItemtitle mb-3"><Link to={`/single-listing-05/${item.id}`}>{item.title}<span className="verified"><BsPatchCheckFill className="m-0"/></span></Link></h5>
