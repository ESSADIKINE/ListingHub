...
export default function ListLayout3() {
  return (
    <>
        <NavbarDark/>
        ...
        <div className="image-cover hero-banner overflow-hidden py-5" style={{backgroundImage:`url(${bg})`, backgroundColor:'#ffe8ee'}}>
            <div className="container">
                <div className="row justify-content-start align-items-start">
                    <div className="col-xl-8 col-lg-10 col-md-12 col-sm-12 py-lg-0 py-5">
                            ...
                            <div className="heroSearch rounded-search style-01 mt-4">
                                <div className="row gx-lg-2 gx-md-2 gx-3 gy-sm-2 gy-2">
                                    ...
                                    <div className="col-xl-2 col-lg-3 col-md-12 col-sm-12">
                                        <div className="form-group">
                                            <button type="button" className="btn btn-primary rounded-pill full-width fw-medium"><BsSearch className="me-2"></BsSearch>Search</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="viewOptions">
                                    <ul className="nav nav-pills nav-fill gap-2 small d-inline-flex primary-soft rounded-2">
                                        <li className="nav-item" role="presentation">
                                            <Link to="/list-layout-03" className="nav-link rounded-2 active d-flex align-items-center"><BsList className="me-2"/>List</Link>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <Link to="/grid-layout-03" className="nav-link rounded-2 d-flex align-items-center"><BsUiRadiosGrid className="me-2"/>Grid</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                        ...
                                                        <div className="listTitle d-block mb-4">
                                                            <div className="d-flex align-items-start justify-content-between gap-2">
                                                                <div className="flex-first">
                                                                    ...
                                                                    <h5 className="listItemtitle mb-3"><Link to={`/single-listing-03/${item.id}`}>{item.title}<span className="verified"><BsPatchCheckFill className="m-0"/></span></Link></h5>
