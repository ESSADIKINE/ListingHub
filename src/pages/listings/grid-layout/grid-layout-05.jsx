...
export default function GridLayout5() {
  return (
    <>
     <ThemNavbar/>
                            ...
                            <div className="viewOptions">
                                <ul className="nav nav-pills nav-fill gap-2 small d-inline-flex primary-soft rounded-2">
                                    <li className="nav-item" role="presentation">
                                        <Link to="/list-layout-05" className="nav-link rounded-2 d-flex align-items-center" id="listViews" role="tab" aria-selected="true"><BsList className="me-2"/>List</Link>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <Link to="/grid-layout-05" className="nav-link rounded-2 active d-flex align-items-center" id="gridViews" role="tab" aria-selected="false"><BsUiRadiosGrid className="me-2"/>Grid</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-xl- 5 col-lg-5 col-md-5 col-sm-6 col-6">
                            <div className="text-end">
                                <div className="dropdown d-inline-flex p-0">
                                    <a className="py-2 px-3 dropdown-toggle toogleDrops" id="shortfilter" data-bs-toggle="dropdown" aria-expanded="false">
                                        Short Listings
                                    </a>
                                                ...
                                                <div className="opssListing position-absolute start-0 bottom-0 ms-3 mb-4 z-2">
                                                    <div className="d-flex align-items-center justify-content-between gap-2">
                                                        ...
                                                        <div className="listing-details">
                                                            <h4 className="listingTitle"><Link to={`/single-listing-05/${item.id}`} className="titleLink">{item.title}<span className="verified"><BsPatchCheckFill className="bi bi-patch-check-fill m-0"/></span></Link></h4>
