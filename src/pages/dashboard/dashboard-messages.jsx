                                        ...
                                        <div className="card-body p-0">
                                            <ul className="dashboardListgroup nospace">
                                                {message.map((item,index)=>{
                                                    return(
                                                        <li key={index}>
                                                            <Link to="#" onClick={() => setSelectedMessage(item)} className="singleMessageswrap" data-bs-toggle="modal" data-bs-target="#conversionModal">
                                                                <div className="singleMessages">
                                                                    ...
                                                                    <div className="messagesInfo">
                                                                        <div className="messagesupper d-flex align-items-center justify-content-between gap-2 mb-1">
                                                                            ...
                                                                            <div className="flxLast"><span className="text-md text-muted">{item.tine}</span></div>
                                                                        </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content bg-transparent">
                <div className="chatboxWraper" id="conversionModalLabel">
                    ...
                    <div className="bg-cover chatboxHeader py-5" style={{backgroundImage:`url(${bg})`}} data-overlay="5">
                        <Link to="#" data-bs-dismiss="modal" aria-label="Close" className="close"><BsX/></Link>
                    ...
                    <div className="chatboxbody">
                        <div id="chat-messages" className="animate">
                            ...
                            <div className="message right">
                                <img src={team4} alt=""/>
                                <div className="bubble">
                                    Yah! Why not please share yor email.
                                    <div className="corner"></div>
                                    <span>2 min</span>
                                </div>
                            </div>
                            ...
                            <div className="message">
                                <img src={selectedMessage?.image} alt=""/>
                                <div className="bubble">
                                    This is my id "mitchel.warm@gmail.com"
                                    <div className="corner"></div>
                                    <span>1 min</span>
                                </div>
                            </div>
