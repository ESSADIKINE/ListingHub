...
export default function TwoFactorAuth() {
  return (
    <section style={{backgroundImage:`url(${bg})`, backgroundPosition:'center', backgroundRepeat:'no-repeat', backgroundColor:'#ffe8ee' , backgroundSize:'cover', height:'100vh'}}>
                ...
                <div className="col-xl-5 col-lg-7 col-md-9">
                    <div className="authWrap">
                                        ...
                                        <div className="form mt-3">
                                            ...
                                            <div className="modal-flex-item d-flex align-items-center justify-content-between mb-3">
                                                ...
                                                <div className="modal-flex-last">
                                                    <Link to="#" className="text-primary fw-medium text-decoration-underline">Click to Resend</Link>
                                                </div>
                                            </div>
                        ...
                        <div className="authfooter">
                            <div className="text-center"><p className="text-dark mb-0">Back to<Link to="/register" className="fw-medium text-primary">  Sign In</Link></p></div>
                        </div>
                    </div>
                </div>
            </div>
