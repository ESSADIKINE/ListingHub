...
import { FaFacebook, FaGooglePlusG } from 'react-icons/fa6'
                    ...
                    <div className="col-xl-5 col-lg-7 col-md-9">
                        <div className="authWrap">
                            <div className="authhead">
                                <div className="text-center mb-4"><Link to="/"><img className="img-fluid" src={logo} width="55" alt="logo"/></Link></div>
                            </div>
                                            ...
                                            <div className="form mb-5">
                                                ...
                                                <div className="form-group form-border">
                                                    ...
                                                    <div className="position-relative">
                                                        ...
                                                        <span className="fa-solid fa-eye toggle-password position-absolute top-50 end-0 translate-middle-y me-3"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="social-login">
                                                <div className="d-flex align-items-center justify-content-center flex-wrap gap-3 p-0">
                                                    <div className="flex-first flex-fill mob-100">
                                                        <Link to="#" className="btn bg-white border text-dark full-width">
                            ...
                            <div className="authfooter">
                                <div className="text-center"><p className="text-dark mb-0">Are you new here?<Link to="/register" className="fw-medium text-primary"> Create an account</Link></p></div>
                            </div>
                        </div>
                    </div>
                </div>
