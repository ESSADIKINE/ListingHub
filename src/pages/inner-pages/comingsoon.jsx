...
export default function Comingsoon() {
  return (
    <div>
        <div id="main-wrapper" className='image-cover d-flex align-items-center justify-content-center' style={{backgroundImage:`url(${bg})`, height:'100vh'}} data-overlay="6">
            <div className="">
                <div className="position-absolute end-0 top-0 me-3 mt-3 z-2"><Link to="/" className="square--50 circle bg-light-primary text-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Back to Home"><FaHome className="fa fa-home"/></Link></div>			
                <div className="container position-relative z-2">
                    <div className="row align-items-center justify-content-center">
                        <div className="col-xl-7 col-lg-9 col-md-11 col-12">
                            <div className="logo-brand text-center mb-4"><img src={logo} className="img-fluid" width="250" alt=""/></div>
