...
import bg from '../../assets/img/avatar-bg-2.jpg'
                ...
                <div className="col-xl-8 col-lg-8 col-md-12 pt-lg-0 pt-5">
                    <div className="authorBoxesGroups d-flex align-items-start flex-column gap-4 w-100">
                        ...
                        <div className="singleauthorBox d-block">
                            <div className="card">
                                <div className="bg-cover card-header py-3 px-4 position-relative" style={{backgroundImage:`url(${bg})`}} data-overlay="4">
                                    <div className="position-absolute end-0 top-0 me-3 mt-3 z-1">
                                        <Link to="#" className="btn btn-sm btn-whites fw-medium rounded-pill"><BsPersonCheck className="me-2"/>Follow</Link>
                                    </div>
                                    <div className="avatarBox position-relative z-1 py-5 mt-5">
                                        <div className="d-flex align-items-center justify-content-start gap-3">
                                            <div className="square--80 circle bg-transparents mx-auto p-1 z-2"><img src={user} className="img-fluid circle" alt="Avatar"/></div>
                                ...
                                <div className="col-xl- 5 col-lg-5 col-md-5 col-sm-6 col-6">
                                    <div className="text-end">
                                        <div className="dropdown d-inline-flex p-0">
                                            <Link to="#" className="py-2 px-3 bg-white dropdown-toggle toogleDrops" id="shortfilter" data-bs-toggle="dropdown" aria-expanded="false">
                                                Short Listings
                                            </Link>
                                                ...
                                                <div className="row align-items-center justify-content-start g-3">
                                                    ...
                                                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                                        <div className="listThumb overflow-hidden position-relative">
                                                            ...
                                                            <Link to="#" className="d-block"><img src={item.image} className="img-fluid list-thumb object-fit" alt="Listing Img"/></Link>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="listTitle d-block mb-4">
                                                                <div className="d-flex align-items-start justify-content-between gap-2">
                                                                    <div className="flex-first">
                                                                        ...
                                                                        <h5 className="listItemtitle mb-3"><Link to={`/single-listing-02/${item.id}`}>{item.title}<span className="verified"><BsPatchCheckFill className="m-0"/></span></Link></h5>
                                                                    ...
                                                                    <div className="flex-last">
                                                                        <Link to="#" className="bookmarkList"><FaHeart className=""/></Link>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div className="col-xl-12 col-lg-12 col-md-12">
                                    <nav aria-label="Page navigation example">
                                        <ul className="pagination justify-content-center">
                                            ...
                                            <li className="page-item">
                                                <Link to="#" className="page-link"><i className="fa-solid fa-arrow-right"></i></Link>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                        ...
                        <div className="card">
                            <div className="card-body p-0">
                                <div className="avatarBox my-4">
                                    <div className="square--100 circle bg-secondary mx-auto mb-2 p-2"><img src={user} className="img-fluid circle" alt="Avatar"/></div>
                            ...
                            <div className="card-footer bg-white border-top">
                                <div className="d-flex align-items-center justify-content-center gap-3">
                                    <div className="flexSocial"><Link to="#" className="square--40 circle border"><BsFacebook className="color--facebook"/></Link></div>
                                    <div className="flexSocial"><Link to="#" className="square--40 circle border"><BsTwitter className="color--twitter"/></Link></div>
                                    <div className="flexSocial"><Link to="#" className="square--40 circle border"><BsInstagram className="color--instagram"/></Link></div>
                                    <div className="flexSocial"><Link to="#" className="square--40 circle border"><BsYoutube className="color--pinterest"/></Link></div>
                                    <div className="flexSocial"><Link to="#" className="square--40 circle border"><BsWhatsapp className="color--whatsapp"/></Link></div>
                                </div>
                            </div>
                        </div>									
