...
import img2 from '../../assets/img/j.jpg'
import img3 from '../../assets/img/i.jpg'
    ...
    <section className="bg-light">
        <div className="container">
            <div className="row justify-content-start align-items-center">
                <div className="col-xl-7 col-lg-9 col-md-12 col-sm-12 py-lg-0 py-5">
                    <div className="position-relative">
                        <h1 className="xl-heading">Cart Page</h1>
                        <nav id="breadcrumbs" className="breadcrumbs">
                            <ul>
                                <li><Link to="#">Home</Link></li><MdArrowForwardIos className='ms-2'/>
                                <li><Link to="#">Shop</Link></li><MdArrowForwardIos className='ms-2'/>
                                <li>Cart</li>
                            </ul>
                        </nav>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link to="#" className="d-inline-block"><img src={img1} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                    <td data-label="Item Name">
                                    <div className="itemInfo">
                                        <h6 className="fw-semibold"><Link to="#" className="link">Shine Water Cattle</Link></h6>
                                    ...
                                    <td data-label="Action">
                                        <div className="removeItem"><Link to="#" className="square--30 d-inline-flex circle badge-primary"><BsXLg/></Link></div>
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link to="#" className="d-inline-block"><img src={img2} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                    <td data-label="Item Name">
                                    <div className="itemInfo">
                                        <h6 className="fw-semibold"><Link to="#" className="link">Classic Flower Vase</Link></h6>
                                ...
                                <tr>
                                    <td className="cartThumbnail">
                                        <Link to="#" className="d-inline-block"><img src={img3} className="img-fluid rounded" alt="Thumbnail"/></Link>
                                    </td>
                                    <td data-label="Item Name">
                                    <div className="itemInfo">
                                        <h6 className="fw-semibold"><Link to="#" className="link">Long Flower Vase</Link></h6>
