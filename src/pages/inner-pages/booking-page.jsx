...
import listImg from '../../assets/img/list-4.jpg'
                        ...
                        <div className="row align-items-start justify-content-start mt-4 g-2">
                            ...
                            <div className="col-xl-12 col-lg-12 col-md-12 col-12">
                                <div className="form-group form-border m-0">
                                    <Link to="/success-payment" className="btn btn-primary fw-medium rounded-pill w-100">Proceed & Pay</Link>
                                </div>
                            </div>
                            ...
                            <div className="paymentPagewrap">
                                <div className="paymentPage">
                                    <div className="bookingList">
                                        <img src={listImg} className="img-fluid" alt="Listing Image"/>	
                                        <div className="listing-details">
                                            <h5>The Blue Ley Light<span className="verified"><i className="bi bi-patch-check-fill m-0"></i></span></h5>
