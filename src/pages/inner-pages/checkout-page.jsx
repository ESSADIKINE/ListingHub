            ...
            <div className="row">
                <div className="col-lg-12 col-md-12">
                    <div className="alert alert-success text-center" role="alert">
                        Hi Dear, Have you already an account? <Link to="#" className="alert-link" data-bs-toggle="collapse" data-bs-target="#login-frm">Please Login</Link>
                    </div>
                </div>
                    ...
                    <div className="row align-items-start justify-content-start mt-4 g-2">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-12">
                            <div className="form-group form-border m-0">
                                <Link to="/success-payment" className="btn btn-primary fw-medium w-100">Place Your Order</Link>
                            </div>
                        </div>
