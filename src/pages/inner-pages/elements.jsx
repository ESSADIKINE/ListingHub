                    ...
                    <div className="elementWrap">
                        ...
                        <div className="elementContent">
                            <div className="d-flex align-items-start gap-3 flex-wrap">
                                <Link to="#" className="btn btn-primary rounded-pill">Filled Button</Link>
                                <Link to="#" className="btn btn-primary rounded-pill"><BsTwitter className="me-2"/>Filled Icon Button</Link>
                                <Link to="#" className="btn btn-outline-primary rounded-pill">Border Button</Link>
                                <Link to="#" className="btn btn-outline-primary rounded-pill"><BsTwitter className="me-2"/>Border Icon Button</Link>
                                <Link to="#" className="btn btn-light-primary rounded-pill">Light Button</Link>
                                <Link to="#" className="btn btn-light-primary rounded-pill"><BsTwitter className="me-2"/>Light Icon Button</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-6 col-lg-6 col-md-6">
                    <div className="elementWrap">
                        ...
                        <div className="elementContent">
                            ...
                            <div className="alert alert-primary alert-dismissible fade show">You should check in on some of those fields below.<Link className="close" data-bs-dismiss="alert" aria-label="Close"></Link></div>
                        </div>
                    </div>
                </div>
