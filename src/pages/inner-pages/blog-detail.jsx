...
import blogImg from '../../assets/img/gal-4.jpg'
                        ...
                        <div className="position-relative">
                            ...
                            <nav id="breadcrumbs" className="breadcrumbs">
                                <ul>
                                    ...
                                    <li><Link hrefto="#">Blog</Link></li><MdArrowForwardIos className='ms-2'/>
                                    <li>Blog Detail</li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div className="blogDetails d-flex align-items-start gap-4 flex-column w-100">
                            <div className="card shadow-sm w-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <h1 class="fs-3">{data?.title ? data?.title : 'Top 10 Free Bootstrap Templates for Your Next Project'}</h1>
                                    <div className="d-flex align-items-center justify-content-start flex-wrap gap-3 mb-3">
                                        <div>By <Link to="#" className="link">Adam Michel</Link></div>
                                        <div>12 Sep 2024</div>
                                        <div><Link to="#" className="link">24 Comments</Link></div>
                                    </div>
                                    ...
                                    <blockquote className="bg-light-primary rounded text-center p-3 p-md-4 my-4">
                                        <h6 className="fw-normal lh-base"><FaQuoteLeft className="me-2"/>Asking the client to pay no attention Lorem Ipsum isn't hard as it doesn’t make sense in the first place, that will limit any initial interest soon enough. Try telling a client to ignore draft copy however, and you're up to something you can't win.<i className="fa-solid fa-quote-right ms-2"></i></h6>
                                                    ...
                                                    <div className="blogCaps">
                                                        <div className="d-flex align-items-start justify-content-between gap-3 mb-3">
                                                            ...
                                                            <div className="replyLink">
                                                                <Link to="#" className="btn btn-sm btn-light rounded-pill" data-bs-toggle="modal" data-bs-target="#commentModal"><i className="bi bi-reply me-2"></i>Reply</Link>
                                                            </div>
                                                        </div>
