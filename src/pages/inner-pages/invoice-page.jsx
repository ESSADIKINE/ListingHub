						...
						<div className="col-xl-9 col-lg-9 col-md-12">
							<div className="card card-body shadow-lg border-0 p-4 p-lg-5">
								<div className="d-flex justify-content-between align-items-start pb-4 pb-md-5 mb-4 mb-md-5 border-bottom">
									<div>
										...
										<Link to="#" className="fw-medium text-primary">hello@sugar.cogen.com</Link>
									</div>
									<img src={logo} width="150" className="img-fluid" alt="Logo"/>
								</div>
								<div className="mb-4">
							...
							<div className="printInvoice d-block mt-4">
								<div className="d-flex align-items-center justify-content-center gap-2 w-100">
									<Link to="#" className="btn btn-sm btn-outline-primary rounded-pill fw-medium"><BsDownload className="me-1"/>Download</Link>
									<Link to="#" className="btn btn-sm btn-outline-primary rounded-pill fw-medium"><BsPrinter className="me-1"/>Print Invoice</Link>
								</div>
							</div>
