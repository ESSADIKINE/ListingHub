                                ...
                                <div className="row align-items-center mt-5 mb-2">
                                    <div className="col-xl-6 col-lg-8 col-md-9 mx-auto">
                                        ...
                                        <div className="list-group hstack gap-3 justify-content-center flex-wrap mb-0">
                                            <Link to="#" className="btn-link text-decoration-underline p-0 mb-0"> How can we help?</Link>
                                            <Link to="#" className="btn-link text-decoration-underline p-0 mb-0"> How to upload data to the system? </Link>
                                            <Link to="#" className="btn-link text-decoration-underline p-0 mb-0"> Installation Guide?</Link>
                                            <Link to="#" className="btn-link text-decoration-underline p-0 mb-0"> How to view expired tickets? </Link>
                                            <Link to="#" className="btn-link p-0 mb-0">View all question</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6" key={index}>
                                <div className="helpCategories">
                                    <div className="iconlink">
                                        ...
                                        <div className="link"><Link to="/single-helps" className="link"><BsBoxArrowInRight/></Link></div>									
                                    </div>
                    ...
                    {articles.map((item,index)=>{
                        return(
                            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12" key={index}>
                                <Link to="/single-helps" className="popularArticles">
