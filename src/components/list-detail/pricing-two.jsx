  ...
  return (
        <div className="listingSingleblock mb-4" id="pricingss">
            <div className="SingleblockHeader">
                <Link data-bs-toggle="collapse" data-parent="#pricing" data-bs-target="#pricing" aria-controls="pricing" to="#" aria-expanded="false" className="collapsed"><h4 className="listingcollapseTitle">Extra Amenities Pricing</h4></Link>
            </div>
