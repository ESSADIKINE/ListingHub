                        ...
                        <div className="singlelisting-item">
                            ...
                            <div className="listing-middle-item">
                                ...
                                <div className="listing-details">
                                    <h4 className="listingTitle"><Link to="/single-listing-02" className="titleLink">{item.title}<span className="verified"><BsPatchCheckFill className="bi bi-patch-check-fill m-0"/></span></Link></h4>
                                    <p>{item.desc}</p>
                                </div>
