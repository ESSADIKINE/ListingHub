                        ...
                        <ul className="nav-menu">
                            ...
                            <li className={`${['/author-profile','/booking-page','/about-us','/blog','/contact-us','/pricing','/help-center','/comingsoon','/faq','/error','/elements','/privacy-policy','/checkout-page','/success-payment','/invoice-page','/viewcart'].includes(current)? 'active' : ''}`}><Link to="#">Pages<span className="submenu-indicator"><span className="submenu-indicator-chevron"></span></span></Link>
                                <ul className="nav-dropdown nav-submenu">
                                    ...
                                    <li className={`${current === '/pricing' ? 'active' : ''}`}><Link to="/pricing" className='d-flex'><BsCoin className="bi bi-coin me-1 align-self-center"/>Pricing</Link></li>										
                                    <li className={`${current === '/privacy-policy' ? 'active' : ''}`}><Link to="/privacy-policy" className='d-flex'><BsCoin className="bi bi-coin me-1 align-self-center"/>Privacy Policy</Link></li>										
                            ...
                            <li><Link className="mob-addlisting light" to="#"><BsGeoAltFill className="me-1"/>Add Listing</Link></li>
                        </ul>
                                ...
                                <div className="btn-group account-drop">
                                    ...
                                    <div className="dropdown-menu pull-right animated flipInX">
                                        ...
                                        <ul>
                                            ...
                                            <li><Link to="/dashboard-add-listing"><BsPatchPlus className="me-2"/>Add Listing</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
