...
import { BsList, BsStarFill, BsUiRadiosGrid } from 'react-icons/bs'
import MultiRangeSlider from "multi-range-slider-react";
import RangeSlider from "./range-slider";

export default function FilterOne({list}) {
                                        ...
                                        <div className="card-body p-4">
                                            <div className="filterButton">
                                                ...
                                                <div className="filterFlex">
                                                    <input type="radio" className="btn-check" name="ratingsfilters" id="all" checked/>
                ...
                <div className="col">
                    <ul className="nav nav-pills nav-fill gap-2 small d-inline-flex lightprimary border rounded-pill p-1 float-end">
                        <li className="nav-item" role="presentation">
                            <Link to="/list-layout-02" className={`nav-link rounded-pill d-flex align-items-center ${list ? 'active' : ''}`} id="buy1"><BsList className="me-2"/>List</Link>
                        </li>
                        <li className="nav-item" role="presentation">
                            <Link to="/grid-layout-02" className={`nav-link rounded-pill d-flex align-items-center ${!list ? 'active' : ''}`} id="rent1"><BsUiRadiosGrid className="me-2"/>Grid</Link>
                        </li>
                    </ul>
                </div>
            </div>
