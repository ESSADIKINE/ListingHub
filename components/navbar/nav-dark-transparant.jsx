...
export default function NavDarkTransparant() {
  ...
  return (
    <>
        <div className={`header header-transparent nav-dark ${scroll ? 'header-fixed' : ''}`} data-sticky-element="">
                    ...
                    <div className={`nav-menus-wrapper  ${toggle ? 'nav-menus-wrapper-open' : ''}`} style={{transitionProperty:toggle ? 'none' : 'left'}}>
                        ...
                        <ul className="nav-menu nav-menu-social align-to-right">
                            ...
                            <li className="list-buttons">
                                <Link href="/register" className='text-white'><BsGeoAlt className="fs-6 me-1 text-white"/><span className='text-white'>Add Listing</span></Link>
                            </li>
                        </ul>
                    </div>
                </nav>
