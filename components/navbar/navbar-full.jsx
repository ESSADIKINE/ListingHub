...
const facebookLogo = '/assets/img/facebook.png'
const brand1 = '/assets/img/brand/logo-1.png'
const brand2 = '/assets/img/brand/logo-2.png'
const brand3 = '/assets/img/brand/logo-3.png'
const list1 = '/assets/img/list-3.jpg'
...
export default function NavbarFull() {
    ...
    return (
        <>
            <div className={`header header-light head-fixed head-shadow ${scroll ? 'header-fixed' : ''}`} data-sticky-element="">
                <div className="container-fluid">
                    <nav id="navigation" className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                        <div className="nav-header">
                            <Link className="nav-brand" href="/"><img src={logo} className="logo" alt="" /></Link>
                            ...
                            <ul className="nav-menu">
                                ...
                                <li className={`${['/grid-layout', '/grid-layout-02', '/grid-layout-03', '/grid-layout-04', '/grid-layout-05', '/grid-layout-06', '/list-layout', '/list-layout-02', '/list-layout-03', '/list-layout-04', '/list-layout-05', '/half-map', '/half-map-02', '/half-map-03', '/half-map-04', '/half-map-05', '/single-listing', '/single-listing-02', '/single-listing-03', '/single-listing-04', '/single-listing-05'].includes(current) ? 'active' : ''}`}><Link href="#">Listings<span className="submenu-indicator"><span className="submenu-indicator-chevron"></span></span></Link>
                                    <ul className="nav-dropdown nav-submenu">
                                        ...
                                        <li className={`${['/half-map', '/half-map-02', '/half-map-03', '/half-map-04', '/half-map-05'].includes(current) ? 'active' : ''}`}><Link href="#">Half Map Screen<span className="submenu-indicator"><span className="submenu-indicator-chevron"></span></span></Link>
                                            <ul className="nav-dropdown nav-submenu">
                                                <li className={`${current === '/half-map' ? 'active' : ''}`}><Link href="/half-map">Half Map Screen 01</Link></li>
                                        ...
                                        <li className={`${['/single-listing', '/single-listing-02', '/single-listing-03', '/single-listing-04', '/single-listing-05'].includes(current) ? 'active' : ''}`}><Link href="#">Single Listings<span className="submenu-indicator"><span className="submenu-indicator-chevron"></span></span></Link>
                                            <ul className="nav-dropdown nav-submenu">
                                                <li className={`${current === '/single-listing' ? 'active' : ''}`}><Link href="/single-listing">Single Listing 01</Link></li>
                ...
                <div className="offcanvas-body">
                    ...
                    <div className="cartButtons w-100 py-2">
                        <div className="d-flex align-items-center justify-content-center flex-wrap gap-2">
                            <Link href="/viewcart" className="btn btn-md btn-light-primary fw-medium flex-fill">View Cart</Link>
                            <Link href="/checkout-page" className="btn btn-md btn-primary fw-medium flex-fill">Checkout</Link>
                        </div>
                    </div>
                </div>
            </div>
