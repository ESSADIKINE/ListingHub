...
export default function FilterTwo({list}) {
  ...
  return (
    <>
        ...
        <div className="map-content-bxo py-5">
            <div className="filterOption-02 mb-3">
                <div className="row align-items-start justify-content-center g-3">
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="form-group form-border position-relative mb-0">
                            <input type="search" className="form-control fw-medium ps-5" placeholder="What you are looking for?"/>
                            <span className="position-absolute top-50 start-0 translate-middle text-muted ms-4"><BsSearch className="opacity-75"/></span>
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="form-group form-border position-relative mb-0">
                            <input type="search" className="form-control fw-medium ps-5" placeholder="Type location"/>
                            <span className="position-absolute top-50 start-0 translate-middle text-muted ms-4"><BsCrosshair2 className="opacity-75"/></span>
                        </div>
                    </div>
            ...
            <div className="filterOptions-wrap d-flex justify-content-between align-items-center gap-2">
                ...
                <div className="filter-mobile d-lg-none flex-fill">
                    <a href="#filterSlider" data-bs-toggle="offcanvas" data-bs-target="#filterSlider" aria-controls="filterSlider" className="btn btn-md btn-light-primary full-width"><i className="bi bi-funnel me-2"></i>Filter Option</a>
                </div>
                
                <div className="filterOptions-wrap d-flex justify-content-between align-items-center gap-2">
                    <div className="filter-mobile d-lg-none">

                        <a href="#filterSlider" data-bs-toggle="offcanvas" data-bs-target="#filterSlider" aria-controls="filterSlider" className="btn btn-md btn-light-primary rounded-pill"><i className="bi bi-funnel me-2"></i>Filter Option</a>
                    </div>
                    
                    <div className="filter-desktop d-none d-lg-block">
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <a href="#" className="py-2 px-3 dropdown-toggle toogleDrops" id="catsfilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Categories
                            </a>
                        ...
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <a href="#" className="py-2 px-3 dropdown-toggle toogleDrops" id="ratingsfilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Rating Filter
                            </a>
                            <div className="dropdown-menu border shadow-sm">
                                <div className="card rounded-3">
        ...
        <div className="offcanvas offcanvas-start" data-bs-scroll="true" tabIndex="-1" id="filterSlider" aria-labelledby="filterSliderLabel" style={{zIndex:'99999'}}>
                    ...
                    <div className="search-inner">
                        ...
                        <div className="prtsTypes mb-4">
                            <div className="filterButton">
                                ...
                                <div className="filterFlex">
                                    <input type="radio" className="btn-check" name="ratingsfilter" id="alls" checked/>
                        ...
                        <div className="form-group form-border filter_button mb-0">
