...
const bg2 = '/assets/img/avatar-bg-2.jpg'
...
export default function SingleSidebarThree() {
  ...
  return (
        <div className="sidebarGroups d-flex flex-column gap-4">
            ...
            <div className="card">
                <div className="bg-cover card-header py-3" style={{backgroundImage:`url(${bg2})`}} data-overlay="4">
                    <div className="avatarBox position-relative z-1">
                        <div className="d-flex align-items-center justify-content-start gap-3">
                            <div className="square--80 circle bg-transparents mx-auto p-1 z-2"><img src={team4} className="img-fluid circle" alt="Avatar"/></div>
