...
const bg = '/assets/img/avatar-bg.jpg'
const team4 = '/assets/img/team-4.jpg'
import { BsBrowserChrome, BsCalendar, BsEnvelope, BsFacebook, BsInstagram, BsSendCheck, BsSuitHeart, BsTwitterX, BsWhatsapp, BsYoutube } from 'react-icons/bs'
import { BiPhone } from 'react-icons/bi'
import Link from 'next/link'
import { FaMinus, FaPlus } from 'react-icons/fa6'
import Select from 'react-select';

export default function SingleSidebarTwo() {
        ...
        <div className="sidebarGroups d-flex flex-column gap-4">
            ...
            <div className="card">
                <div className="">
                    <div className="avatarBox my-4">
                        <div className="square--100 circle bg-light mx-auto mb-2 p-2"><img src={team4} className="img-fluid circle" alt="Avatar"/></div>
                        <div className="listingInfo text-center">
                            <p className="text-md text-muted mb-0">Hosted By</p>
                            <h6 className="mb-0">Shree K. Patel</h6>
                        </div>
                        <div className="followButtons d-block mt-3">
                            <div className="d-flex align-items-center justify-content-center gap-3 flex-wrap px-4">
                                <button type="button" className="btn btn-md btn-light-primary fw-medium flex-fill" data-bs-toggle="modal" data-bs-target="#messageModal"><BsEnvelope className="me-2"/>Send Message</button>
                                <button type="button" className="btn btn-md btn-light-success fw-medium flex-fill"><BsSendCheck className="me-2"/>Follow Vendor</button>
                            </div>
                        </div>
                    </div>
            ...
            <div className="card overflow-visible">
                <div className="card-header py-3">
                    <div className="headerFirst"><h6><BsCalendar className="me-2"/>Booking Rooms</h6></div>
                </div>
